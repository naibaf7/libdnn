...
IF (APPLE)
  ...
  FIND_PATH(OPENCL_CPP_INCLUDE_DIRS OpenCL/cl.hpp DOC "Include for OpenCL CPP bindings on OSX")
...
ELSE (APPLE)
	...
	IF (WIN32)
	    ...
	    FIND_PATH(OPENCL_CPP_INCLUDE_DIRS CL/cl.hpp)
	    ...
	    FIND_PATH(OPENCL_CPP_INCLUDE_DIRS CL/cl.hpp PATHS "${_OPENCL_INC_CAND}" $ENV{CUDA_INC_PATH} $ENV{CUDA_PATH}/include)
